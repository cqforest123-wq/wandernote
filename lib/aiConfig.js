...
export const AI_PROXY_URL = 'https://wandernote-ai-proxy.wandernote.workers.dev';

// 与 worker 上 `wrangler secret put APP_TOKEN` 设置的值保持一致。
// 这个值会打进 app 包里，只是挡一下随手抓取，不是真正的鉴权。
export const AI_PROXY_TOKEN = '35c63ba1fbd554927724885df0202259dadf0822b3adfab7';
