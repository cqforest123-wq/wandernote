      ...
      <NavigationContainer>
        <Stack.Navigator screenOptions={{headerShown:false}}>
          {activeTab==='home' && <>
            ...
            <Stack.Screen key={langKey + "TripMemo"} name="TripMemo">{props=><MemoScreen {...props} isPro={isPro}/>}</Stack.Screen>
          </>}

          {activeTab==='memo' && (
            <Stack.Screen key={langKey + "Memo"} name="Memo">{props=><MemoScreen {...props} isPro={isPro}/>}</Stack.Screen>
          )}
          {activeTab==='map' && (
